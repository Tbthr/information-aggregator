...
- [ ] 1.3 [P] 扩展 SourcePack/InlineSource 类型
  - **Do**:
...
- [ ] 1.4 [VERIFY] Quality checkpoint: types
  - **Do**: Run type check
...
- [ ] 1.6 [VERIFY] Quality checkpoint: config
  - **Do**: Run type check
  - **Verify**: `bun run check`
  - **Done when**: No type errors
  - **Commit**: None
...
- [ ] 1.9 [VERIFY] Quality checkpoint: db
  - **Do**: Run type check
  - **Verify**: `bun run check`
  - **Done when**: No type errors
  - **Commit**: None
...
- [ ] 1.11 [P] 创建 filter-then-assist prompt
  - **Do**:
